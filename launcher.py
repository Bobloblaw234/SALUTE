...
class Launcher(QWidget):
    ...
    def run_app1(self):
        subprocess.Popen(['cmd', '/C', 'start', 'cmd', '/K',
                          r'python -m streamlit run C:\Users\jones\PycharmProjects\SALUTE\SALUTE.py'])

    def run_app2(self):
        subprocess.Popen(['cmd', '/C', 'start', 'cmd', '/K',
                          r'python -m streamlit run C:\Users\jones\PycharmProjects\SALUTE\export_SALUTE.py'])

    def run_app3(self):
        subprocess.Popen(['cmd', '/C', 'start', 'cmd', '/K',
                          r'python -m streamlit run C:\Users\jones\PycharmProjects\SALUTE\upload_images.py'])
